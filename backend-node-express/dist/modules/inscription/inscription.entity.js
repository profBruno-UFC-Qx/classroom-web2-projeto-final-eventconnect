...
const event_entity_js_1 = require("../event/event.entity.js");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_js_1.User, (user) => user.inscricaos, { nullable: false, onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_js_1.User)
], Inscription.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => event_entity_js_1.Event, (evento) => evento.inscricaos, { nullable: false, onDelete: 'CASCADE' }),
    __metadata("design:type", event_entity_js_1.Event)
], Inscription.prototype, "evento", void 0);
__decorate([
